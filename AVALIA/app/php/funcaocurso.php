                    ...
                    .'<div class="row" align="center">'
                        .'<div class="col-6">'
                            .'<a href="#modalEditCurso'.$coluna["idCurso"].'" data-toggle="modal">'
                                .'<h6><i class="fas fa-edit text-info" data-toggle="tooltip" title="Alterar curso"></i></h6>'
                            .'</a>'
                        .'</div>'
                        
                        .'<div class="col-6">'
                            .'<a href="#modalDeleteCurso'.$coluna["idCurso"].'" data-toggle="modal">'
                                .'<h6><i class="fas fa-trash text-danger" data-toggle="tooltip" title="Deletar curso"></i></h6>'
                            .'</a>'
                        .'</div>'
                    .'</div>'
                .'</td>'
